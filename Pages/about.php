...
<body>
    ...
    <section class="navbar">
        <div>
            <nav>
                <a href="../index.php"><img src="../Assets/images/hmlogotr.png"></a>
                <div class="nav-links">
                    <ul>
    ...
    <section class="about">
        <div class="hello">
            <h3>About Hello Material</h3>
            <p>Your trusted partner in construction and industrial materials since 2010</p>
        </div>
        <div>
    ...
    <section class="Mission">
        <div class="mission-row">
            <div mission-col>
                <h2>Our Story</h2>
                <p>Founded in 2010, Hello Material began with a simple <br> mission: to make quality construction
                    materials accessible <br> to builders, contractors, and businesses of all sizes. <br> <br>

                    What started as a small local supplier has grown into a <br> comprehensive materials marketplace,
                    connecting <br> thousands of customers with trusted suppliers across the <br> nation.</p>

            </div>
            <div mission-col>
                <h2>Our Mission</h2>
                <p>We strive to be the leading platform for construction and <br> industrial materials, providing our
                    customers with easy <br> access to quality products, competitive pricing, and <br> exceptional
                    service. <br> <br> We believe in building lasting relationships with our <br> customers and
                    suppliers, based on trust, transparency, and <br> mutual success.</p>
    ...
    <section class="choose">
        ...
        <div class="row">
            <div class=cours-col1>
                <img src="../Assets/images/quality first icon.JPG">
                <h3>Quality First</h3>
                <p>We partner only with certified manufacturers <br> and suppliers who meet the highest industry <br>
                    standards.</p>

            </div>
            <div class=cours-col1>
                <img src="../Assets/images/customer focus icon.JPG">
                <h3>Customer Focus</h3>
                <p>Your success is our priority. We provide <br> personalized service and expert guidance for <br> every
                    project.</p>

            </div>
            <div class=cours-col1>
                <img src="../Assets/images/reliability icon.JPG">
                <h3>Reliability</h3>
                <p>Count on us for consistent quality, on-time <br> delivery, and dependable support throughout <br>
                    your project.</p>
        ...
        <div class="our-team">
            <h5>Our Team</h5>
            <p>Hello Material is powered by a dedicated team of <br> industry professionals with decades of combined
                experience in construction materials, supply chain management, and customer <br> service.</p>
        </div>
        <div class="expert">
            <div>
                <h5>Expert Team</h5>
                <p>Industry professionals with deep knowledge of materials <br> and construction</p>
            </div>
            <div>
                <h5>Customer Support</h5>
                <p>Dedicated support staff available to assist with your needs <br> 24/7</p>
            </div>
            <div>
                <h5>Quality Assurance</h5>
                <p>Rigorous verification process for all suppliers and products</p>
            </div>
        </div>
