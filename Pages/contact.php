    ...
    <section>
        <div>
            ...
            <div class="contact-page">
                <h2>Contact Us</h2>
                <p>Have questions about our products or services? Get in touch with our team and we'll be
                    happy <br> to help you.</p>
            </div>
        </div>
    </section>
            ...
            <div class="page-container">
                <aside class="sidebar">
                    <div class="address-box">
                        <img src="../Assets/images/locationnew-removebg-preview.png" alt=""></i>
                        <div class="address-content">
                            <h4>Our Location</h4>
                            <p> Addis Ababa,Bole</p>
                            <p>Mickey Leland Street NB Bussiness Center</p>
                        </div>
                    </div>

                    <div class="address-box">
                        <img src="../Assets/images/phonenew-removebg-preview.png" alt=""></i>
                        <div class="address-content">
                            <h4>Call Us</h4>
                            <p>+251911007914/+251912305272</p>
                            <p>Mon-Sat: 9am - 5pm</p>
                        </div>
                    </div>

                    <div class="address-box">
                        <img src="../Assets/images/mailnew-removebg-preview.png" alt=""></i>
                        <div class="address-content">
                            <h4>Email Us</h4>
                            <p>info@helomaterial.com</p>
                            <p>We typically reply within 24 hours</p>
                        </div>
                    </div>

                    <div class="address-box">
                        <img src="../Assets/images/clocknew-removebg-preview.png" alt=""></i>
                        <div class="address-content">
            ...
            <form action="./connect.php" method="POST" class="contact-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" name="fullname" placeholder="Abrahaley Tesfay" required>
                    </div>
                    <div class="form-group">
                        <label for="email">Email Address</label>
                        <input type="email" id="email" name="email" placeholder="aaabrlove@example.com" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="tel" id="phone" name="phone" placeholder="+251911007914" required>
                    </div>
                    <div class="form-group">
                        <label for="subject">Subject</label>
                        <input type="text" id="subject" name="subject"
                            placeholder="Can You Prepare Company Profile for us?" required>
                    </div>
                </div>
                ...
                <button type="submit" class="mes"> Send Message</button>
...
if ($status == 'success') {
 ...
 ?>
    ...
    <section class="location">
        ...
        <div class="map">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2786.4124071740484!2d38.77798552859544!3d9.010534180356634!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x164b850a39eb5b3f%3A0x65997316c3ca1898!2zTkIgQnVzaW5lc3MgQ2VudGVyIHwgQ2hpY2hpbnlhIHwg4Yqk4YqV4YmqIOGLqOGMiOGJoOGLqyDhiJvhiqXhiqjhiI0gfCDhibrhibrhipXhi6s!5e0!3m2!1sen!2set!4v1763744694203!5m2!1sen!2set"
