...
<div class="container">
    ...
    <section class="navbar">
        <div>
            <nav>
                <a href="index.php"><img src="Assets/images/hmlogotr.png" alt="home-page"></a>
                <div class="nav-links">
    ...
    <Section class="header">
        <div>
            <div class="header-text1">
                <p></p>Your Premier Source for Quality Building Materials</p>
                <h3>Find everything you need for your construction and industrial projects. Browse our <br>
                    extensive catalog and connect with trusted suppliers.</h3>
            </div>
            ...
            <div class="search-box1">
                ...
                <form action="./Pages/product.php" method="get">
                    ...
                    <input type="query" id="query" name="query"
                        placeholder="&#128269;&nbsp;Search for materials, products, or companies"
                        aria-label="Search through site content">

                    <button type="query">&#128269;Search </button>



                </form>
                
<a href="./Assets/link-files/2018 1st Q. CONSTRUCTION WORKS ONLY DIRECT COST 01.02.2018.pdf" download="./Assets/link-files/2018 1st Q. CONSTRUCTION WORKS ONLY DIRECT COST 01.02.2018.pdf" download class="download-btn" target="_blank">Download 2018 1st Quarter Direct Construction Cost </a>
            </div>

            <p class="textundersearch">Try searching: "steel bars", "cement", "electrical wire", "PlumbPro
                Solutions"</p>
            <div class="btns">
                <button class="brbtn"><a href="./Pages/product.php">
                        <p>Browth Products&nbsp;&nbsp;&#8594;</p>
                    </a> </button>
                <button class="ctbtn"><a href="./Pages/contact.php">
                        <p>Contact Us</p>
                    </a></button>
            </div>
        </div>
    ...
    <section class="choose">
        ...
        <h4>Why Choose Hello Material?</h4>

        <div class="row">
            <div class=cours-col1>
                <img src="Assets/images/cube icon.JPG">
                <h3>Wide Selection</h3>
                <p>Thousands of quality materials from trusted <br>manufacturers</p>

            </div>
            <div class=cours-col1>
                <img src="Assets/images/vehicle icon.JPG">
                <h3>Fast Delivery</h3>
                <p>Quick and reliable delivery to your project site</p>

            </div>
            <div class=cours-col1>
                <img src="Assets/images/quality icon.JPG">
                <h3>Quality Assured</h3>
                <p>All products meet industry standards and <br>certifications</p>
    ...
    <section class="procuct-catagory">
        ...
        <div class="row1">
            <div class="product-col">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    class="lucide lucide-arrow-right h-5 w-5 text-blue-600" aria-hidden="true">
    ...
    <section class="advert">
        ...
        <div class="overlay">
            <div>
                <h4>Feature Partner</h4>
            </div>
            <div>
                <p>Premium Construction Equipment Sale</p>
            </div>
            <div>
                <h2>Get up to 30% off on professional-grade tools and equipment.<br> Limited time offer from our
                    trusted partners!</h2>
            </div>
            <div class="list">
                <ul>
                    <li>Industry-leading brands</li>
                    <li>Warranty included</li>
                    <li>Free installation support</li>
                </ul>
                <button class="brbtn3">Learn More &#8594;</button>
            </div>

        </div>
        <img src="./Assets/images/advertimgedited.png" alt="">
    </section>
    <section class="getstarted">

        <p>Ready to Start Your Project?</p>
        <h3>Get in touch with our team today to discuss your material needs and receive <br> a custom quote.</h3>
        <div>
            <button class="brbtn6"><a href="./Pages/contact.php">Get a Quote</a> &#8594;</button>
        </div>
    </section>
    <!-- footer -->
